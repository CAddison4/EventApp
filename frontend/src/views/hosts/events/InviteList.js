...
export default function InviteList({ navigation, route }) {
  ...
  return (
	<View style={styles.container}>
		{eventObj &&
			  <><Text style={styles.title}>All Users</Text><Text style={styles.eventInfo}>Event - {eventObj.event_name}</Text><Text style={styles.eventInfo}>Max Capacity - {eventObj.capacity}</Text><Text style={styles.eventInfo}>Checked - {numChecked}</Text><FlatList
				  data={users}
				  renderItem={({ item }) => (
					  <View style={styles.userContainer}>
						  <Text onPress={() => navigation.navigate("UserDetails", { user: item })} style={styles.userName}>
